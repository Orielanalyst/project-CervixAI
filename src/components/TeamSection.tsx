  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      role: "Founder & CEO",
      image: "Oriel.jpg",
      bio: "Data Analyst and Ph.d student in Physics in the University of Bamenda",
      socials: {
    ...
    {
      name: "Ngam Lois Nabuin",
      role: "Product Manager",
      image: "Lois.jpg",
      bio: "Masters in Public Health (MPH) in University of Buea",
      socials: {
        linkedin: " "
      }
    }
  ];
  // Second row of team members (advisors/specialists)
